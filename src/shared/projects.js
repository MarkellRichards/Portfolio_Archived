export const PROJECTS = [
  {
    ...
    role:
      'I was in charge of the entire project. I started by creating my own brand identity, creating logo, color scheme, typography, and mock-up wireframes. Then I converted my design to a full web page using React',
    difficulties:
